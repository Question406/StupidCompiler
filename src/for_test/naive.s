...
_copy_ifTrue2:
    ...
    j	paracopy8
paracopy8:
    mv	__largest.3,__largest.1 
    j	_copy_if_end2
_copy_if_end2:
    beq	__largest.3,largest.3,	Heap_Node.maxHeapify.exitBB1
    j	_copy_if_end3
_copy_if_end3:
    lw __t.0, 0(t.0)
    lw ___t.0, 0(__t.0)
...
_copy_if_thenBB3:
    ...
    j	_copy_if_end5
_copy_if_end5:
    beq	__largest.2,__largest.3,	Heap_Node.maxHeapify.exitBB1
    j	_copy_if_end6
_copy_if_end6:
    lw __t.0, 0(t.0)
    lw ___t.0, 0(__t.0)
...
paracopy14:
    ...
    j	_copy_if_end8
_copy_if_end8:
    beq	__largest.3,__largest.2,	Heap_Node.maxHeapify.exitBB1
    j	_copy_if_end9
_copy_if_end9:
    lw __t.0, 0(t.0)
    lw ___t.0, 0(__t.0)
...
_copy_if_thenBB5:
    ...
    j	_copy_if_end11
_copy_if_end11:
    beq	__largest.4,__largest.3,	Heap_Node.maxHeapify.exitBB1
    j	_copy_if_end12
...
_copy_if_thenBB7:
    ...
    j	_copy_if_end8
paracopy13:
    mv	__largest.2,__largest.2 
    j	_copy_if_end7
paracopy12:
    mv	__largest.2,__largest.2 
    j	_copy_if_end7
paracopy11:
    mv	__largest.2,__largest.1 
    j	_copy_if_end5
paracopy10:
    mv	__largest.2,__largest.1 
    j	_copy_if_end5
...
_copy_ifTrue9:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB9
    j	paracopy22
paracopy22:
    mv	__largest.4,zero 
    j	_copy_if_end13
_copy_if_end13:
    ...
    lw ___t.0, 4(___t.0)
    li t, 2
    blt	t,___t.0,	_copy_ifTrue10
    j	paracopy23
paracopy23:
    mv	__largest.6,__largest.4 
    j	_copy_if_end14
_copy_if_end14:
    beq	__largest.6,zero,	afterCallBB3
    j	_copy_if_end15
_copy_if_end15:
    ...
    add ___t.0,___t.0,___t.0
    sw ___t.0,0(___t.0)
    slli ___t.0,__largest.6,    1
    addi ___t.0,___t.0,    1
    slli ___t.0,__largest.6,    1
    addi ___t.0,___t.0,    2
    lw ___t.0, 0(____t.0)
    lw ___t.0, 4(___t.0)
    blt	___t.0,___t.0,	_copy_ifTrue11
    j	paracopy24
paracopy24:
    mv	__largest.3,__largest.6 
    j	_copy_if_end16
_copy_if_end16:
    lw ___t.0, 0(____t.0)
    lw ___t.0, 4(___t.0)
    blt	___t.0,___t.0,	_copy_ifTrue12
    j	paracopy25
paracopy25:
    mv	__largest.4,__largest.3 
    j	_copy_if_end17
_copy_if_end17:
    beq	__largest.4,__largest.6,	afterCallBB3
    j	_copy_if_end18
afterCallBB3:
    lw __t.0, 0(____t.0)
    slli __t.0,__t.0,    2
...
_copy_if_end18:
    ...
    lw ___t.0, 0(____t.0)
    lw ___t.0, 4(___t.0)
    blt	___t.0,___t.0,	_copy_ifTrue13
    j	paracopy26
paracopy26:
    mv	__largest.3,__largest.4 
    j	_copy_if_end19
_copy_if_end19:
    lw ___t.0, 0(____t.0)
    lw ___t.0, 4(___t.0)
    blt	___t.0,___t.0,	_copy_ifTrue14
    j	paracopy27
paracopy27:
    mv	__largest.5,__largest.3 
    j	_copy_if_end20
_copy_if_end20:
    beq	__largest.5,__largest.4,	afterCallBB3
    j	_copy_if_end21
_copy_if_end21:
    lw __t.0, 0(__t.0)
    lw ___t.0, 0(__t.0)
...
_copy_ifTrue14:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB10
    j	paracopy28
_copy_if_thenBB10:
...
_copy_ifTrue13:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB11
    j	paracopy29
paracopy29:
    mv	__largest.3,__largest.4 
    j	_copy_if_end19
...
_copy_ifTrue12:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB12
    j	paracopy30
paracopy30:
    mv	__largest.4,__largest.3 
    j	_copy_if_end17
...
_copy_ifTrue11:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB13
    j	paracopy31
paracopy31:
    mv	__largest.3,__largest.6 
    j	_copy_if_end16
...
_copy_ifTrue10:
    ...
    sub ___t.0,zero,___t.0
    sw ___t.0,0(___t.0)
    bgt	___t.0,___t.0,	_copy_if_thenBB14
    j	paracopy32
_copy_if_thenBB14:
    li __largest.6, 2
    j	_copy_if_end14
