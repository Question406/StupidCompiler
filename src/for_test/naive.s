...
_forcondBB1:
    ...
    call	stringLength
    mv	_t.0,a0 
    blt	_i.4,_t.0,	_forbodyBB1
    j	_afterForBB1
_afterForBB1:
    mv	_mergedretVal.3,_result.3 
...
__forbodyBB3:
    ...
    j	__forcondBB4
__forcondBB4:
    blt	__i.10,__digit.3,	__forbodyBB4
    j	__whileBodyBB1
__forbodyBB4:
    li t, 4
    mul __t.0,__i.10,t
...
__if_thenBB2:
    ...
    j	__forcondBB5
__forcondBB5:
    blt	__i.13,__digit.3,	__forbodyBB5
    j	__afterForBB4
__forbodyBB5:
    li t, 4
    mul __t.0,__i.13,t
...
afterCallBB5:
    ...
    mv	a0,__t.0 
    call	print
    addi __i.14,__i.13,    1
    mv	__i.13,__i.14 
    mv	breaker,__i.13 
    j	__forcondBB5
_if_end4:
    la _mergedretVal.4,_globalStr0    
...
__if_end5:
    ...
    mv	__mergedretVal.4,__mergedretVal.7 
...
_if_end2:
    ...
    j	_forcondBB4
_forcondBB4:
    blt	_i.6,_nChunk.3,	_forbodyBB4
    j	_afterForBB4
_afterForBB4:
    mv	_i.8,zero 
    j	_forcondBB5
_forcondBB5:
    blt	_i.8,_length.3,	_forbodyBB5
    j	_afterForBB5
_forbodyBB5:
    li t, 64
    div _t.0,_i.8,t
...
_afterForBB5:
    ...
    j	_forcondBB6
_forcondBB6:
    blt	_i.11,_nChunk.3,	_forbodyBB6
    j	_afterForBB6
_afterForBB6:
    ...
    mv	_mergedretVal.3,_mergedretVal.5 
    mv	breaker,_mergedretVal.3 
    j	afterCallBB3
_forbodyBB6:
    li _j.8, 16
...
_forcondBB8:
    li t, 80
    blt	_j.10,t,	_forbodyBB8
    j	_afterForBB8
_forbodyBB8:
    li t, 20
    blt	_j.10,t,	_if_thenBB11
    j	_if_elseBB6
_if_elseBB6:
    li t, 40
    blt	_j.10,t,	_if_thenBB12
    j	_if_elseBB7
_if_thenBB12:
    xor _t.0,_b.6,_c.6
    xor _t.0,_t.0,_d.6
...
__if_thenBB11:
    ...
    or __t.0,__t.0,__t.0
    mv	__mergedretVal.9,__t.0 
    mv	__mergedretVal.7,__mergedretVal.9 
    mv	breaker,__mergedretVal.7 
    j	_afterCallBB4
_forbodyBB4:
    mv	_j.14,zero 
...
_if_end6:
    ...
    j	_forcondBB11
_forcondBB11:
    blt	_i.3,_nChunk.1,	_forbodyBB11
    j	_afterForBB9
_afterForBB9:
    mv	_i.5,zero 
    j	_forcondBB12
_forcondBB12:
    blt	_i.5,_length.1,	_forbodyBB12
    j	_afterForBB10
_forbodyBB12:
    li t, 64
    div _t.0,_i.5,t
...
_afterForBB10:
    ...
    j	_forcondBB13
_forcondBB13:
    blt	_i.8,_nChunk.1,	_forbodyBB13
    j	_afterForBB11
_forbodyBB13:
    li _j.5, 16
    j	_forcondBB14
...
_afterForBB11:
    ...
    addi _t.0,_goutputBuffer.0,    20
    sw _h4.2,0(_t.0)
    mv	_mergedretVal.2,_goutputBuffer.0 
    mv	_mergedretVal.3,_mergedretVal.2 
    mv	breaker,_mergedretVal.3 
    j	afterCallBB7
_forbodyBB11:
