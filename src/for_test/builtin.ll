...
define dso_local i32 @stringLength(i8* nocapture readonly) local_unnamed_addr #4 {
...
; Function Attrs: nounwind uwtable
define dso_local noalias i8* @_stringSubstring(i8* nocapture readonly, i32, i32) local_unnamed_addr #3 {
  %4 = sub nsw i32 %2, %1
  %5 = add nsw i32 %4, 1
  %6 = sext i32 %5 to i64
...
; Function Attrs: nounwind uwtable
define dso_local i32 @_stringParseInt(i8* nocapture readonly) local_unnamed_addr #3 {
...
define dso_local i32 @_stringOrd(i8* nocapture readonly, i32) local_unnamed_addr #6 {
  %3 = sext i32 %1 to i64
...
; Function Attrs: norecurse nounwind readonly uwtable
define dso_local i32 @_arraySize(i8* nocapture readonly) local_unnamed_addr #6 {
...
; Function Attrs: nofree nounwind uwtable
define dso_local i8* @_stringAdd(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #0 {
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringEqual(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringNotEqual(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
  %3 = tail call i32 @strcmp(i8* %0, i8* %1) #10
  %4 = icmp ne i32 %3, 0
  %5 = zext i1 %4 to i32
  ret i32 %5
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringLess(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
  %3 = tail call i32 @strcmp(i8* %0, i8* %1) #10
  %4 = lshr i32 %3, 31
  ret i32 %4
}
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringLessEqual(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
  %3 = tail call i32 @strcmp(i8* %0, i8* %1) #10
  %4 = icmp slt i32 %3, 1
  %5 = zext i1 %4 to i32
  ret i32 %5
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringGreater(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
  %3 = tail call i32 @strcmp(i8* %0, i8* %1) #10
  %4 = icmp sgt i32 %3, 0
  %5 = zext i1 %4 to i32
  ret i32 %5
...
; Function Attrs: nounwind readonly uwtable
define dso_local i32 @_stringGreaterEqual(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #4 {
  %3 = tail call i32 @strcmp(i8* %0, i8* %1) #10
  %4 = lshr i32 %3, 31
  %5 = xor i32 %4, 1
  ret i32 %5
